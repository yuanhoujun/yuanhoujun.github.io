...
针对这个问题，最好的答案是`git blame`，使用这个命令并指定具体文件它将显示文件每一行代码的最近修改记录，你可以清晰地看待最近代码的修改人。

# 总结
Git是一个非常优秀的版本控制系统，我极力推荐你在日常开发中使用。这篇文章从小明的角度解释了几个常见问题的解决方案，毫无悬念地，你可能还会遇到其它的一些问题。遇到问题，你可以尝试Google搜索解决方案。也可以在文章下方给我留言，我非常乐意为你解答Git问题。

---

我是欧阳锋，我愿为你鞍前马后，助你平步青云。如果你喜欢我的文章，请在下方留下你爱的印记。如果你不喜欢我的文章，请先喜欢上我的文章，然后再留下爱的印记。
